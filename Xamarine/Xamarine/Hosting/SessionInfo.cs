...
namespace Xamarine.Hosting
{
    ...
    {
        private readonly Lazy<ConcurrentDictionary<string, object>> _lazyData = new Lazy<ConcurrentDictionary<string, object>>(() => new ConcurrentDictionary<string, object>(Strings.StandardStringComparer));
