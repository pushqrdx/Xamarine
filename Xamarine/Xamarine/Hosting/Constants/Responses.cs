namespace Xamarine.Hosting.Constants
{
    /// <summary>
    ...
    internal static class Responses
    {
        ...
        /// </summary>
        internal const string Response500HtmlFormat = "<html><head></head><body><h1>500 - Internal Server Error</h1><h2>Message</h2><pre>{0}</pre><h2>Stack Trace</h2><pre>\r\n{1}</pre></body></html>";
