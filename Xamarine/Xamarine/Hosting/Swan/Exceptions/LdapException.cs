using System;
using System.Linq;
using Xamarine.Hosting.Swan.Networking.Ldap;

#if !UWP
namespace Xamarine.Hosting.Swan.Exceptions
{
    /// <summary>
    ...
    public class LdapException : Exception
    {
        ...
        /// </returns>
        public string LdapErrorMessage => _serverMessage != null && _serverMessage.Length == 0 ? null : _serverMessage;
        ...
        ///     <ul>
        ///         <li>NO_SUCH_OBJECT</li><li>ALIAS_PROBLEM</li><li>INVALID_DN_SYNTAX</li><li>ALIAS_DEREFERENCING_PROBLEM</li>
        ///     </ul>
        /// </summary>
        /// <value>
        ///     The matched dn.
        ...
        public override string ToString()
        {
            ...
            return _referrals != null ? _referrals.Aggregate(msg, (current, referral) => current + $"\r\nServer Message: {referral}") : msg;
        }
