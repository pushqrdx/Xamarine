...
namespace Xamarine.Hosting.Swan
{
    ...
    public class LogMessageReceivedEventArgs : EventArgs
    {
        ...
        public LogMessageReceivedEventArgs(ulong sequence, LogMessageType messageType, DateTime utcDate, string source, string message, object extendedData, string callerMemberName, string callerFilePath, int callerLineNumber)
        {
            Sequence = sequence;
