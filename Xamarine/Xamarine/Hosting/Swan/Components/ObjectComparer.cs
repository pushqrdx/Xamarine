...
namespace Xamarine.Hosting.Swan.Components
{
    ...
    public static class ObjectComparer
    {
        ...
        public static bool AreStructsEqual(object left, object right, Type targetType)
        {
            ...
            var fields = new List<MemberInfo>(Runtime.FieldTypeCache.RetrieveAllFields(targetType)).Union(Runtime.PropertyTypeCache.RetrieveAllProperties(targetType));
            ...
            foreach (var targetMember in fields)
                switch (targetMember)
                {
                    ...
                    case PropertyInfo property:
                        ...
                        if (targetPropertyGetMethod != null && Equals(targetPropertyGetMethod.Invoke(left, null), targetPropertyGetMethod.Invoke(right, null)) == false)
                            return false;
                        break;
                }
        ...
        ///     right.
        /// </exception>
        public static bool AreEnumerationsEquals<T>(T left, T right) where T : IEnumerable
        {
            if (left == null)
