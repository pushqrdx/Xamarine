...
namespace Xamarine.Hosting.Swan.Components
{
    ...
    public static class ProcessRunner
    {
        ...
        {
            return GetProcessOutputAsync(filename, string.Empty, ct);
        }
        ...
        /// </returns>
        public static async Task<string> GetProcessOutputAsync(string filename, string arguments, string workingDirectory, CancellationToken ct = default)
        {
        ...
        /// <param name="ct">The cancellation token.</param>
        /// <returns>
        ///     Text of the standard output and standard error streams along with the exit code as a <see cref="ProcessResult" />
        ///     instance.
        /// </returns>
        ...
        /// <exception cref="ArgumentNullException">filename.</exception>
        /// <example>
        ///     The following code describes how to run an external process using the
        ///     <see cref="GetProcessResultAsync(string, string, string, Encoding, CancellationToken)" /> method.
        ///     <code>
        /// class Example
        /// {
        /// using System.Threading.Tasks;
        ...
        public static async Task<ProcessResult> GetProcessResultAsync(string filename, string arguments = "", string workingDirectory = null, Encoding encoding = null, CancellationToken ct = default)
        {
            ...
            var processReturn = await RunProcessAsync(filename, arguments, workingDirectory, (data, proc) => { standardOutputBuilder.Append(encoding.GetString(data)); },
                                                      (data, proc) => { standardErrorBuilder.Append(encoding.GetString(data)); }, encoding, true, ct);
        ...
        /// </returns>
        public static Task<int> RunProcessAsync(string filename, string arguments, string workingDirectory, ProcessDataReceivedCallback onOutputData, ProcessDataReceivedCallback onErrorData, Encoding encoding, bool syncEvents = true,
        ...
        ///     <see
        ///         cref="RunProcessAsync(string, string, ProcessDataReceivedCallback, ProcessDataReceivedCallback, bool, CancellationToken)" />
        ///     method.
        ///     <code>
        /// class Example
        /// {
        ...
        {
            return RunProcessAsync(filename, arguments, null, onOutputData, onErrorData, Definitions.CurrentAnsiEncoding, syncEvents, ct);
        }
        ...
        private static Task<ulong> CopyStreamAsync(Process process, Stream baseStream, ProcessDataReceivedCallback onDataCallback, bool syncEvents, CancellationToken ct)
        {
