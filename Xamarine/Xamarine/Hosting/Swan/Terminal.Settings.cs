        ...
        public static class Settings
        {
            static Settings()
            {
                if (IsDebuggerAttached)
                    DisplayLoggingMessageType = LogMessageType.Debug | LogMessageType.Error | LogMessageType.Info | LogMessageType.Trace | LogMessageType.Warning | LogMessageType.Fatal;
                else
                    DisplayLoggingMessageType = LogMessageType.Error | LogMessageType.Info | LogMessageType.Warning | LogMessageType.Fatal;
            }
