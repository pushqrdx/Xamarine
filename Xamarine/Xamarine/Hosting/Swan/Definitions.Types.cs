...
using System.Linq;
using System.Net;
using Xamarine.Hosting.Swan.Reflection;
...
#region Main Dictionary Definition
        ...
        /// </summary>
        public static readonly Dictionary<Type, ExtendedTypeInfo> BasicTypesInfo = new Dictionary<Type, ExtendedTypeInfo>
        {
            // Non-Nullables
        ...
        ///     All numeric types.
        /// </value>
        public static List<Type> AllNumericTypes { get; } = new List<Type>(BasicTypesInfo.Where(kvp => kvp.Value.IsNumeric).Select(kvp => kvp.Key).ToArray());
        ...
        /// </value>
        public static List<Type> AllNumericValueTypes { get; } = new List<Type>(BasicTypesInfo.Where(kvp => kvp.Value.IsNumeric && kvp.Value.IsNullableValueType == false).Select(kvp => kvp.Key).ToArray());
        ...
        /// </value>
        public static List<Type> AllBasicValueTypes { get; } = new List<Type>(BasicTypesInfo.Where(kvp => kvp.Value.IsValueType).Select(kvp => kvp.Key).ToArray());
        ...
        /// </value>
        public static List<Type> AllBasicValueAndStringTypes { get; } = new List<Type>(BasicTypesInfo.Where(kvp => kvp.Value.IsValueType || kvp.Key == typeof(string)).Select(kvp => kvp.Key).ToArray());
        ...
        /// </value>
        public static List<Type> AllBasicNullableValueTypes { get; } = new List<Type>(BasicTypesInfo.Where(kvp => kvp.Value.IsNullableValueType).Select(kvp => kvp.Key).ToArray());
    }
}
