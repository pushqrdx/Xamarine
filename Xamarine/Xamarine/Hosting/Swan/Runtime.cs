        ...
        public static OperatingSystem OS
        {
            get
            {
                if (_oS.HasValue == false)
                {
                    ...
                    if (string.IsNullOrEmpty(windowsDirectory) == false && windowsDirectory.Contains(@"\") && Directory.Exists(windowsDirectory))
...
#region Methods
        ...
        public static string GetDesktopFilePath(string filename)
        {
            ...
            var pathWithFilename = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory), filename);
