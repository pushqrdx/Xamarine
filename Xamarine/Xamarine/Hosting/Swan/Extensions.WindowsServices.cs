...
namespace Xamarine.Hosting.Swan
{
    ...
    public static class WindowsServicesExtensions
    {
        ...
        public static void RunInConsoleMode(this ServiceBase[] servicesToRun)
        {
            ...
            var onStartMethod = typeof(ServiceBase).GetMethod(onStartMethodName, BindingFlags.Instance | BindingFlags.NonPublic);
            var onStopMethod = typeof(ServiceBase).GetMethod(onStopMethodName, BindingFlags.Instance | BindingFlags.NonPublic);
