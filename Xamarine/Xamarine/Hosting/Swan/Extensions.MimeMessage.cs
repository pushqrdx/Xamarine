...
namespace Xamarine.Hosting.Swan
{
    ...
    public static class SmtpExtensions
    {
        ...
        public static MemoryStream ToMimeMessage(this MailMessage self)
        {
            ...
            MimeMessageConstants.SendMethod.Invoke(self, MimeMessageConstants.PrivateInstanceFlags, null, MimeMessageConstants.IsRunningInDotNetFourPointFive ? new[] {mailWriter, true, true} : new[] {mailWriter, true}, null);

            result = new MemoryStream(result.ToArray());
            MimeMessageConstants.CloseMethod.Invoke(mailWriter, MimeMessageConstants.PrivateInstanceFlags, null, new object[] { }, null);
            result.Position = 0;
            return result;
        }
