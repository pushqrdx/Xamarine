...
namespace Xamarine.Hosting.Swan
{
    ...
    public static class StringExtensions
    {
        ...
        {
            return Encoding.UTF8.GetBytes(value).ComputeMD5(createHasher);
        }
        ...
        public static string ToStringInvariant(this object obj)
        {
            ...
            return Definitions.BasicTypesInfo.ContainsKey(itemType) ? Definitions.BasicTypesInfo[itemType].ToStringInvariant(obj) : obj.ToString();
        }
        ...
        {
            return value.RemoveControlCharsExcept(null);
        }
        ...
        {
            return value == null ? new string[] { } : SplitLinesRegex.Value.Split(value);
        }
        ...
        {
            return value == null ? throw new ArgumentNullException(nameof(value)) : InvalidFilenameChars.Value.Aggregate(value, (current, c) => current.Replace(c, string.Empty)).Slice(0, 220);
        }
        ...
        {
            return ((ulong) bytes).FormatBytes();
        }
        ...
        {
            return Truncate(value, maximumLength, string.Empty);
        }
        ...
        public static string Truncate(this string value, int maximumLength, string omission)
        {
            ...
            return value.Length > maximumLength ? value.Substring(0, maximumLength) + (omission ?? string.Empty) : value;
        }
        ...
        {
            return value >= '0' && value <= '9' ? value - '0' : value >= 'A' && value <= 'F' ? value - 'A' + 10 : value >= 'a' && value <= 'f' ? value - 'a' + 10 : -1;
        }
