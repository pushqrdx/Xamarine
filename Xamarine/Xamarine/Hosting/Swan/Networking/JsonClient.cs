...
using Xamarine.Hosting.Swan.Models;
using Json = Xamarine.Hosting.Swan.Formatters.Json;
...
namespace Xamarine.Hosting.Swan.Networking
{
    ...
    public class JsonClient
    {
        ...
        public static async Task<OkOrError<T, TE>> PostOrError<T, TE>(string url, object payload, int httpStatusError = 500, string authorization = null, CancellationToken ct = default)
        {
            using (var httpClient = GetHttpClientWithAuthorizationHeader(authorization))
            {
                ...
                if (response.StatusCode == HttpStatusCode.OK)
                    return OkOrError<T, TE>.FromOk(!string.IsNullOrEmpty(jsonString) ? Json.Deserialize<T>(jsonString) : default);

                if ((int) response.StatusCode == httpStatusError)
                    return OkOrError<T, TE>.FromError(!string.IsNullOrEmpty(jsonString) ? Json.Deserialize<TE>(jsonString) : default);
        ...
        public static async Task<IDictionary<string, object>> Post(string url, object payload, string authorization = null, CancellationToken ct = default)
        {
            var jsonString = await PostString(url, payload, authorization, ct);
        ...
        public static Task<string> PostString(string url, object payload, string authorization = null, CancellationToken ct = default)
        {
            return SendAsync(HttpMethod.Post, url, payload, authorization, ct);
        }
        ...
        /// <param name="ct">The cancellation token.</param>
        /// <returns>A task with a result of the requested type.</returns>
        public static async Task<T> Put<T>(string url, object payload, string authorization = null, CancellationToken ct = default)
        {
        ...
        public static async Task<IDictionary<string, object>> Put(string url, object payload, string authorization = null, CancellationToken ct = default)
        {
            return await Put<object>(url, payload, authorization, ct) as IDictionary<string, object>;
        }
        ...
        public static Task<string> PutString(string url, object payload, string authorization = null, CancellationToken ct = default)
        {
            return SendAsync(HttpMethod.Put, url, payload, authorization, ct);
        }
        ...
        public static async Task<string> GetString(string url, string authorization = null, CancellationToken ct = default)
        {
            return await (await GetHttpContent(url, authorization, ct)).ReadAsStringAsync();
        }
        ...
        /// <param name="ct">The cancellation token.</param>
        /// <returns>A task with a result of the requested type.</returns>
        public static async Task<T> Get<T>(string url, string authorization = null, CancellationToken ct = default)
        {
        ...
        public static async Task<byte[]> GetBinary(string url, string authorization = null, CancellationToken ct = default)
        {
            return await (await GetHttpContent(url, authorization, ct)).ReadAsByteArrayAsync();
        }
        ...
        public static async Task<IDictionary<string, object>> Authenticate(string url, string username, string password, CancellationToken ct = default)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                var requestContent = new StringContent($"grant_type=password&username={username}&password={password}", Encoding.UTF8, "application/x-www-form-urlencoded");
        ...
        ///     A task with a result of the requested string.
        /// </returns>
        public static Task<string> PostFileString(string url, byte[] buffer, string fileName, string authorization = null, CancellationToken ct = default)
        {
        ...
        public static Task<T> PostFile<T>(string url, byte[] buffer, string fileName, string authorization = null, CancellationToken ct = default)
        {
        ...
        /// <param name="ct">The cancellation token.</param>
        /// <returns>A task with a result of the requested string.</returns>
        public static async Task<string> SendAsync(HttpMethod method, string url, object payload, string authorization = null, CancellationToken ct = default)
        {
            if (string.IsNullOrWhiteSpace(url))
                throw new ArgumentNullException(nameof(url));
        ...
        private static async Task<HttpContent> GetHttpContent(string url, string authorization, CancellationToken ct)
        {
            if (string.IsNullOrWhiteSpace(url))
                throw new ArgumentNullException(nameof(url));
