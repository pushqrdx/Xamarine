...
namespace Xamarine.Hosting.Swan.Networking.Ldap
{
    ...
    internal class Asn1SetOf : Asn1Structured
    {
    ...
    internal abstract class Asn1Object
    {
        ...
        public virtual void SetIdentifier(Asn1Identifier identifier)
        {
            _id = identifier;
        }
    ...
    /// </summary>
    /// <seealso cref="Asn1Object" />
    internal sealed class Asn1OctetString : Asn1Object
    {
    ...
    internal class Asn1Tagged : Asn1Object
    {
        ...
        public override string ToString()
        {
            return Explicit ? base.ToString() + _content : _content.ToString();
        }
    }
    ...
    /// </summary>
    /// <seealso cref="Asn1Object" />
    internal sealed class Asn1Null : Asn1Object
    {
    ...
    /// </summary>
    /// <seealso cref="Asn1Structured" />
    internal sealed class Asn1Set : Asn1Structured
    {
        public const int Tag = 0x11;
