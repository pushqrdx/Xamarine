...
namespace Xamarine.Hosting.Swan.Networking.Ldap
{
    ...
    internal sealed class LdapSearchRequest : LdapMessage
    {
        ...
        ///     <ul>
        ///         <li>SCOPE_BASE - searches only the base DN</li><li>SCOPE_ONE - searches only entries under the base DN</li>
        ///         <li>
        ...
        public LdapSearchRequest(string ldapBase, LdapScope scope, string filter, string[] attrs, int dereference, int maxResults, int serverTimeLimit, bool typesOnly, LdapControl[] cont)
            : base(LdapOperation.SearchRequest, new RfcSearchRequest(ldapBase, scope, dereference, maxResults, serverTimeLimit, typesOnly, filter, attrs), cont)
        {
        }
        ...
        ///     <ul>
        ///         <li>AND - followed by an Iterator value</li><li>OR - followed by an Iterator value</li>
