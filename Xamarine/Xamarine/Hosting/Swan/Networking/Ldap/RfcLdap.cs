...
namespace Xamarine.Hosting.Swan.Networking.Ldap
{
    ...
    internal class LdapSearchResult : LdapMessage
    {
        ...
        {
            return _entry?.ToString() ?? base.ToString();
        }
    }
    ...
    internal class RfcSearchResultReference : Asn1SequenceOf
    {
        ...
        {
            return new Asn1Identifier(LdapOperation.SearchResultReference);
        }
    }
    ...
    internal class RfcExtendedResponse : Asn1Sequence, IRfcResponse
    {
        ...
        {
            return new Asn1OctetString(((Asn1OctetString) Get(1)).ByteValue());
        }

        public Asn1OctetString GetErrorMessage()
        {
            return new Asn1OctetString(((Asn1OctetString) Get(2)).ByteValue());
        }

        public Asn1SequenceOf GetReferral()
        {
            return _referralIndex != 0 ? (Asn1SequenceOf) Get(_referralIndex) : null;
        }

        public override Asn1Identifier GetIdentifier()
        {
            return new Asn1Identifier(LdapOperation.ExtendedResponse);
        }
    }
    ...
    internal class RfcBindResponse : Asn1Sequence, IRfcResponse
    {
        ...
        public override Asn1Identifier GetIdentifier()
        {
            return new Asn1Identifier(LdapOperation.BindResponse);
        }
    }
    ...
    internal class RfcIntermediateResponse : Asn1Sequence, IRfcResponse
    {
        ...
        public Asn1OctetString GetMatchedDN()
        {
            return Size() > 3 ? new Asn1OctetString(((Asn1OctetString) Get(1)).ByteValue()) : null;
        }

        public Asn1OctetString GetErrorMessage()
        {
            return Size() > 3 ? new Asn1OctetString(((Asn1OctetString) Get(2)).ByteValue()) : null;
        }
        ...
        public override Asn1Identifier GetIdentifier()
        {
            return new Asn1Identifier(LdapOperation.IntermediateResponse);
        }
    }
}
#endif
