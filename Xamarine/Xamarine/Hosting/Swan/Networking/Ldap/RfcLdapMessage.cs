...
namespace Xamarine.Hosting.Swan.Networking.Ldap
{
    ...
    internal class RfcControls : Asn1SequenceOf
    {
        ...
        {
            return new Asn1Identifier(CONTROLS, true);
        }
    }
    ...
    internal class RfcSearchResultDone : RfcLdapResult
    {
        ...
        public override Asn1Identifier GetIdentifier()
        {
            return new Asn1Identifier(LdapOperation.SearchResult);
        }
    }
    ...
    internal sealed class RfcSearchResultEntry : Asn1Sequence
    {
        ...
        public override Asn1Identifier GetIdentifier()
        {
            return new Asn1Identifier(LdapOperation.SearchResponse);
        }
    }
