...
namespace Xamarine.Hosting.Swan.Networking.Ldap
{
    ...
    internal class Tokenizer
    {
        ...
        private void RemoveEmptyStrings()
        {
            ...
            {
                if (_elements[index] != string.Empty)
                    continue;
    ...
    {
        public RfcMatchingRuleAssertion(string matchingRule, string type, sbyte[] matchValue, Asn1Boolean dnAttributes = null)
            : base(4)
        {
    ...
    internal class RfcSearchRequest : Asn1Sequence, IRfcRequest
    {
        ...
        {
            return new Asn1Identifier(LdapOperation.SearchRequest);
        }
    }
