...
namespace Xamarine.Hosting.Swan.Networking.Ldap
{
    ...
    public class LdapEntry
    {
        ...
        {
            return _attrs.GetSubset(subtype);
        }
    }
    ...
    public class LdapAttribute
    {
        ...
        {
            return string.Compare(Name, ((LdapAttribute) attribute).Name, StringComparison.Ordinal);
        }
        ...
        public override string ToString()
        {
            ...
            if (_values != null)
            {
                result.Append(", ").Append(_values.Length == 1 ? "value='" : "values='");
    ...
    public class LdapAttributeSet : Dictionary<string, LdapAttribute>
    {
        ...
        ///     attributes:
        ///     <ul>
        ///         <li>    cn</li><li>    cn;lang-ja</li><li>    sn;phonetic;lang-ja</li><li>    sn;lang-us</li>
        ///     </ul>
        ...
        ///     attributes:.
        ///     <ul>
        ///         <li>cn;lang-ja</li><li>sn;phonetic;lang-ja</li>
        ///     </ul>
        /// </summary>
        /// <param name="subtype">
        ...
        ///     example:
        ///     <ul>
        ///         <li> "lang-ja" specifies only Japanese language subtypes</li><li> "binary" specifies only binary subtypes</li>
        ///         <li>
        ...
        {
            return ContainsKey(((LdapAttribute) attr).Name);
        }
