...
namespace Xamarine.Hosting.Swan.Networking
{
    ...
    {
        private static readonly byte[] DiscoverMessage = {48, 41, 2, 1, 1, 4, 6, 112, 117, 98, 108, 105, 99, 160, 28, 2, 4, 111, 81, 45, 144, 2, 1, 0, 2, 1, 0, 48, 14, 48, 12, 6, 8, 43, 6, 1, 2, 1, 1, 1, 0, 5, 0};
            ...
            Task[] tasks =
            {
                Task.Factory.StartNew(async () =>
                {
                    using (var udp = new UdpClient(IPAddress.Broadcast.AddressFamily))
                    {
                        ...
                        await udp.SendAsync(DiscoverMessage, DiscoverMessage.Length, new IPEndPoint(IPAddress.Broadcast, 161));
        ...
        /// </returns>
        public static string GetPublicName(IPEndPoint host)
        {
            return GetString(host, "1.3.6.1.2.1.1.5.0");
        }
