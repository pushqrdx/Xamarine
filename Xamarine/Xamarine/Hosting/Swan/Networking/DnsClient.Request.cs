    ...
    internal partial class DnsClient
    {
        ...
        public class DnsRequest : IDnsRequest
        {
            ...
            public DnsRequest()
            {
                ...
                header = new DnsHeader {OperationCode = DnsOperationCode.Query, Response = false, Id = Random.Next(ushort.MaxValue)};
            }
            ...
            public byte[] ToArray()
            {
                ...
                result.Append(header.ToArray()).Append(Questions.Select(q => q.ToArray()));
        ...
        public class DnsUdpRequestResolver : IDnsRequestResolver
        {
            ...
            public DnsClientResponse Request(DnsClientRequest request)
            {
                ...
                try
                {
                    ...
                    return response.IsTruncated ? _fallback.Request(request) : new DnsClientResponse(request, response, buffer);
                }
                finally
                {
#if NET452
        ...
        public class DnsDomain : IComparable<DnsDomain>
        {
            ...
            {
                return obj is DnsDomain domain && CompareTo(domain) == 0;
            }
        ...
        public class DnsQuestion : IDnsMessageEntry
        {
            ...
            public byte[] ToArray()
            {
                return new MemoryStream(Size).Append(Name.ToArray()).Append(new Tail {Type = Type, Class = Class}.ToBytes()).ToArray();
            }
