...
namespace Xamarine.Hosting.Swan.Networking
{
    ...
    public class SmtpClient
    {
        ...
        {
            var state = new SmtpSessionState {AuthMode = Credentials == null ? string.Empty : SmtpDefinitions.SmtpAuthMethods.Login, ClientHostname = ClientHostname, IsChannelSecure = EnableSsl, SenderAddress = message.From.Address};
        ...
        private class ConnectionAuth
        {
            ...
            {
                _sender.RequestText = $"{SmtpCommandNames.AUTH} {SmtpDefinitions.SmtpAuthMethods.Login} {Convert.ToBase64String(Encoding.UTF8.GetBytes(_credentials.UserName))}";
