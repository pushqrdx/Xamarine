namespace Xamarine.Hosting.Swan.Models
{
    /// <summary>
    ...
    public class OkOrError<T, TError>
    {
        ...
        public static OkOrError<T, TError> FromOk(T ok)
        {
            return new OkOrError<T, TError> {Ok = ok};
        }
        ...
        /// <returns>OkOrError instance.</returns>
        public static OkOrError<T, TError> FromError(TError error)
        {
            return new OkOrError<T, TError> {Error = error};
        }
    }
}
