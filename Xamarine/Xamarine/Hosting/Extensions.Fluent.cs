...
namespace Xamarine.Hosting
{
    ...
    public static partial class Extensions
    {
        ...
        public static WebServer WithStaticFolderAt(this WebServer webserver, string rootPath, string defaultDocument = StaticFilesModule.DefaultDocumentName, bool useDirectoryBrowser = false)
        {
            ...
            webserver.RegisterModule(new StaticFilesModule(rootPath, useDirectoryBrowser) {DefaultDocument = defaultDocument});
            return webserver;
        }
        ...
        /// <param name="webserver">The webserver instance.</param>
        /// <param name="assembly">
        ///     The assembly to load WebApi Controllers from. Leave null to load from the currently executing
        ///     assembly.
        /// </param>
        /// <returns>An instance of webserver.</returns>
        /// <exception cref="System.ArgumentNullException">webserver.</exception>
        public static WebServer LoadApiControllers(this WebServer webserver, Assembly assembly = null)
        {
            ...
            var apiControllers = types.Where(x => x.GetTypeInfo().IsClass && !x.GetTypeInfo().IsAbstract && x.GetTypeInfo().IsSubclassOf(typeof(WebApiController))).ToArray();
        ...
        /// <param name="webserver">The webserver instance.</param>
        /// <param name="assembly">
        ///     The assembly to load WebSocketsServer types from. Leave null to load from the currently
        ///     executing assembly.
        /// </param>
        /// <returns>An instance of webserver.</returns>
        /// <exception cref="System.ArgumentNullException">webserver.</exception>
